    ...
    function addBoardCard(e) {
        ...
        if( title != "" ) {
            ...
            var left = d.createElement('div');
                ...
                left.innerHTML = '<img src="../../../assets/img/svg/watch.svg" alt="" className="svg mr-1">';
    ...
    function addList(e) {
        ...
        if( e.keyCode === 13 ) {
            ...
            if( $(this).val() ) {
                ...
                setAttributes(board, {"className": "board"});

                var boardHeader = d.createElement('div');
                setAttributes(boardHeader, {"className": "board-header d-flex justify-content-between align-items-center mb-10"});

                var h4 = d.createElement('h4');
                setAttributes(h4, {"className": "c2"});
                h4.textContent = $(this).val();
                boardHeader.append(h4);


                var dropdownBtn = d.createElement('div');
                setAttributes(dropdownBtn, {"className": "dropdown-button"});

                var dropdownBtnA = d.createElement('a');
                setAttributes(dropdownBtnA, {"src": "#", "data-toggle": "dropdown", "className": "d-flex align-items-center", "style": "cursor: pointer"});


                var dropdownIcon = d.createElement('div');
                setAttributes(dropdownIcon, {"className": "menu-icon justify-content-center style--two mr-0"});
                ...
                setAttributes(dropdownMenu, {"className": "dropdown-menu dropdown-menu-right"});
                ...
                var boardCompose = d.createElement('div');
                    setAttributes(boardCompose, {"className": "board-composer flex-column d-flex align-items-center justify-content-center"});


                var addAnotherCard = d.createElement('a');
                setAttributes(addAnotherCard, { "href": "#", "className": "add-another-card" });
                addAnotherCard.innerHTML = '<img src="../../../assets/img/svg/plus.svg" alt="" className="svg mr-1">';

                var addAnotherCardSpan = d.createElement('span');
                addAnotherCardSpan.textContent = 'Add another card';
                setAttributes(addAnotherCardSpan, { "className": "font-14 bold c4" });
                addAnotherCard.append(addAnotherCardSpan);
                boardCompose.append(addAnotherCard);


                var addCard = d.createElement('div');
                setAttributes(addCard, { "className": "add-card w-100" });

                var form = d.createElement('form');
                setAttributes(form, { "action": "#" });

                var textarea = d.createElement('textarea');
                setAttributes(textarea, { "placeholder": "List Title", "className": "theme-input-style style--five", "value": "title" });
                form.append(textarea)

                var dateActionWrap = d.createElement('div');
                setAttributes(dateActionWrap, { "className": "d-flex align-items-center justify-content-between mt-2" });

                var date = d.createElement('div');
                setAttributes(date, { "className": "date d-flex align-items-center" });
                date.innerHTML = '<img src="../../../assets/img/svg/watch.svg" alt="" className="svg mr-1">';
    ...
    ** Projects Popups
    ==============================================*/
    // Board Members list toggle className
    $( '.board-members-list' ).find('.member-item').on('click', function(e) {
        $(this).toggleClass('active');
    });
    ...
    // Board Labels list toggle className
    ...
    // Boards Labels Select color add & remove className
    ...
    function addNewLabel() {
        ...
        var labelClass = $('.board-labels-select-color, .edit-labels-no-color').find('.label-item.active > .label').attr('className');
        ...
        var editLabel = d.createElement('a');
            ...
            editLabel.innerHTML = '<i className="icofont-ui-edit"></i>';
    ...
    $( '#projectLabelModal' ).find( '.label-item .edit-label' ).on('click', function(e) {
        ...
        $( '.board-labels-select-color' ).find( '.label-item .label' ).each( (i, ele) => {
            ...
            if($(this).siblings('.label').attr('id') == ele.id) {
                $( '.board-labels-select-color, .edit-labels-no-color' ).find( '.label-item' ).removeClass('active');
                ele.parentNode.classNameList.add('active'); 
            }
        });
    });
        ...
        var checklistItemWrap = d.createElement('div');
            ...
            var posRelative = d.createElement('div');
                ...
                var iconDelete = d.createElement('span');
                    ...
                    iconDelete.innerHTML = '<i className="icofont-trash"></i>';
                    ...
                    var checklistAddControlWrap = d.createElement('div');
                        ...
                        var checklistAddControls = d.createElement('div');
                            ...
                            var iconClose = d.createElement('a');  
                                ...
                                iconClose.innerHTML = '<i className="icofont-close-line"></i>';
