...
$(function() {
    $(document).ready(function () {
        ...
        $('.block-element').on('click', function () {
          ...
          $(block_ele).block({
            message: '<i className="icofont-spinner icon-spin"></i>',
        ...
        $('.block-default-message').on('click', function () {
          var block_ele = $(this).closest('.card');
          $(block_ele).block({
            message: '<span className="semibold"> Loading...</span>',
            timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
              backgroundColor: $white,
              opacity: 0.8,
        ...
        $('.block-custom-message').on('click', function () {
          var block_ele = $(this).closest('.card');
          $(block_ele).block({
            message: '<span className="semibold"> Custom Message...</span>',
            timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
              backgroundColor: $white,
              opacity: 0.8,
        ...
        $('.block-msg-animation').on('click', function () {
          var block_ele = $(this).closest('.card');
          $(block_ele).block({
            message: '<div className="semibold"><i className="icofont-spinner icon-spin"></i>&nbsp; Loading ...</div>',
            fadeIn: 1000,
            fadeOut: 1000,
            timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
        ...
        $('.block-multiple-msgs').on('click', function () {
          ...
          window.setTimeout(function () {
            message.html('<div className="semibold"><span className="bx bx-revision icon-spin text-left"></span>&nbsp; Loading ...</div>');
          }, 0);
      
          window.setTimeout(function () {
            message.html('<div className="semibold">Just a minute...</div>');
          }, 2000);
      
          window.setTimeout(function () {
            message.addClass('bg-success').html('<div className="semibold"><span className="icon-thumbs-o-up text-left"></span>&nbsp; Success</div>');
          }, 4000);
