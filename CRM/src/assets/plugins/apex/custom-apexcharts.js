  ...
  /*==================================
   ...
   /*==================================
    ...
    var pie2_options = {
        ...
        labels: ['Facebook <span className="bold">$15</span>', 'Twitter  <span className="bold">$15</span>', 'Pinterest  <span className="bold">$15</span>', 'Instagram  <span className="bold">$15</span>'],
        responsive: [{
            breakpoint: 1900,
            options: {
                plotOptions: {
